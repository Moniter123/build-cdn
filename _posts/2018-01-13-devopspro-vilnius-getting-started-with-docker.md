...
categories:    speaking
excerpt:       Docker is the hot new thing, the technology that really brought the DevOps movement to a next level. This workshop aims to teach you how to use Docker from the ground up, from setting up your very first Docker container to getting your containers production ready. 
